  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-100 text-slate-900 font-sans">
      ...
      <header className="bg-white border-b-4 border-[#800000] shadow-md print:hidden">
        <div className="max-w-[1700px] mx-auto px-4 py-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-6">
      ...
      <main className="flex-1 max-w-[1700px] w-full mx-auto px-4 py-8 sm:px-6 lg:px-8 space-y-8 print:hidden">
          ...
          <div className="bg-white rounded-2xl border-4 border-slate-900 shadow-xl overflow-hidden">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse border border-black text-xs font-sans">
                <thead>
                  <tr className="bg-slate-900 text-white text-[11px] font-black uppercase tracking-wider border-b border-black select-none">
                    <th className="border border-black p-2 text-center w-10">
                      S.No
                    </th>
                    <th
                      onClick={() => handleSort('faculty')}
                      className="border border-black p-2 cursor-pointer hover:bg-slate-800 transition-colors"
                    >
                    ...
                    <th
                      ...
                      className="border border-black p-2 text-center w-28 text-amber-300 bg-black font-black cursor-pointer hover:bg-slate-900 transition-colors"
                    >
                      <div className="flex items-center justify-center gap-1">
                ...
                <tbody className="divide-y divide-black text-xs font-sans">
                  {workloadStats.facultyList.map((f, idx) => (
                    <tr key={f.id || f.shortName} className="hover:bg-slate-100/90 transition-colors">
                      
                      {/* S.No */}
                      <td className="border border-black p-2 text-center font-bold text-slate-900 text-xs whitespace-nowrap">
                        {idx + 1}
                      </td>

                      {/* Faculty Full Name */}
                      <td className="border border-black p-2 font-black text-slate-900 text-xs whitespace-nowrap">
                        {f.fullName}
                      </td>
                      ...
                      {selectedSection === 'ALL' ? (
                        <td className="border border-black p-2 text-left bg-white font-sans">
                          <div className="space-y-0.5 text-[11.5px] font-medium leading-snug">
                            {getFacultyFormattedAssignments(f, includeTutorials, selectedSection).map((line: AssignmentLine, li: number) => (
                              <div key={li} className="text-slate-900 whitespace-normal">
                                <span className="font-extrabold text-[#0B2545]">{line.branch}</span>
                                <span className="mx-1 font-bold text-[#800000]">→</span>
                        ...
                        <td className="border border-black p-2 bg-amber-100/90 font-black text-black text-center border-x border-amber-300">
                          <span className="inline-flex items-center px-2 py-1 rounded text-xs font-black bg-amber-300 text-amber-950 border border-amber-500 shadow-2xs">
                      ...
                      <td className="border border-black p-2 text-center whitespace-nowrap">
                        <button
                          ...
                          className="px-2.5 py-1 bg-[#0B2545] hover:bg-[#800000] text-white text-[11px] font-extrabold rounded-lg transition-colors inline-flex items-center gap-1 shadow-2xs"
                        >
                          <Layers className="w-3 h-3 text-[#DAA520]" />
                          View Schedule
                        </button>
                      </td>
                    </tr>
